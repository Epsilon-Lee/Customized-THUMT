...
import thumt.data.dataset_c2f as dataset_c2f
...
def main(args):
    ...
    with tf.Graph().as_default():
        if not params.record:
            # Build input queue
            features = dataset_c2f.get_training_input_and_c2f_label(params.input, params.c2f_input, params)
        else:
        ...
        loss = loss_mle + 0.5 * loss_l0 + tf.losses.get_regularization_loss()
        ...
        if params.validation and params.references[0]:
            ...
            eval_inputs = dataset_c2f.sort_and_zip_files(files)
            eval_input_fn = dataset_c2f.get_evaluation_input
        else:
            eval_input_fn = None
