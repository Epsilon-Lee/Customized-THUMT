...
import thumt.data.dataset_prune_l1 as dataset_prune_l1
...
def parse_args(args=None):
    ...
    parser.add_argument("--c2f-input", type=str, nargs=2,
    ...
    parser.add_argument("--c2f-vocabulary", type=str, nargs=2,
...
def override_parameters(params, args):
    ...
    params.vocabulary = {
        ...
        "target_l1": vocabulary.load_vocabulary(params.c2f_vocab[1]),
    }
...
def main(args):
    ...
    with tf.Graph().as_default():
        if not params.record:
            # Build input queue
            features = dataset_prune_l1.get_training_input_and_c2f_label(params.input, params.c2f_input, params)
        else:
        ...
        if len(sharded_losses) > 1:
            losses_mle, losses_l0, losses_l1 = sharded_losses
            ...
            loss_mle, loss_l0, loss_l1 = sharded_losses[0]
        loss = loss_mle + loss_l0 + loss_l1 + tf.losses.get_regularization_loss()
        ...
        if params.validation and params.references[0]:
            ...
            eval_inputs = dataset_prune_l1.sort_and_zip_files(files)
            eval_input_fn = dataset_prune_l1.get_evaluation_input
        else:
            eval_input_fn = None
