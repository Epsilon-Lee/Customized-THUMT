...
import thumt.data.dataset as dataset_c2f_sv
...
def parse_args():
    ...
    parser.add_argument("--c2f-vocabulary", type=str, nargs=1, required=True,
                        help="Path of source and target vocabulary")

    # model and configuration
    parser.add_argument("--models", type=str, required=True, nargs="+",
                        help="Name of the model")
    parser.add_argument("--submodels", type=str, required=True, nargs="+",
...
def override_parameters(params, args):
    ...
    params.vocabulary = {
        ...
        "target_l0": vocabulary.load_vocabulary(args.c2f_vocabulary[0])
    }
