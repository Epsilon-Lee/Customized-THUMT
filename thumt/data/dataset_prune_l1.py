...
def get_training_input_and_c2f_label(filenames, c2f_filenames, params):
    ...
    with tf.device("/cpu:0"):
        ...
        tgt_l1_dataset = tf.data.TextLineDataset(c2f_filenames[1])

        dataset = tf.data.Dataset.zip((src_dataset, tgt_dataset, tgt_l0_dataset, tgt_l1_dataset))
        dataset = dataset.shuffle(params.buffer_size)
        dataset = dataset.repeat()

        # Split string
        dataset = dataset.map(
            lambda src, tgt, tgt_l0, tgt_l1: (
