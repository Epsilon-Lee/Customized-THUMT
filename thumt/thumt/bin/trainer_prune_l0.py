...
import thumt.data.dataset_prune_l0 as dataset_prune_l0
...
def main(args):
    ...
    with tf.Graph().as_default():
        if not params.record:
            # Build input queue
            features = dataset_prune_l0.get_training_input_and_c2f_label(params.input, params.c2f_input, params)
        else:
        ...
        if params.validation and params.references[0]:
            ...
            eval_inputs = dataset_prune_l0.sort_and_zip_files(files)
            eval_input_fn = dataset_prune_l0.get_evaluation_input
        else:
            eval_input_fn = None
