...
index_map_l1=WMT14/h5_to_h7
index_map_l2=WMT14/h7_to_h10
index_map_l3=WMT14/h10_to_h22
index_map_l4=WMT14/h22_to_h23
dev_src=WMT14/newstest2013.bpe.en
dev_tgt=WMT14/newstest2013.bpe.de
parameters="batch_size=4096,device_list=[0],train_steps=500000,eval_steps=2000,num_encoder_layers=6,num_decoder_layers=6,hidden_size=512,filter_size=2048,num_heads=8,attention_dropout=0.1,relu_dropout=0.1,residual_dropout=0.1,update_cycle=2"
output=train_wmt_c2f_4layers_softcoherency

CUDA_VISIBLE_DEVICES=0 python thumt/bin/trainer_4layers_sc.py \
    --model c2f-4l-sc-transformer \
    --submodel c2f-4l-sc \
    --input $train_src $train_tgt \
    --c2f-input $train_tgt_l1 $train_tgt_l2 $train_tgt_l3 $train_tgt_l4 \
    --index-map $index_map_l1 $index_map_l2 $index_map_l3 $index_map_l4 \
